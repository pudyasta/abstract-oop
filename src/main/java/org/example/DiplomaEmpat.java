...
public class DiplomaEmpat extends Diploma {
    private int sertifikatCount = 0;
    private int produkHki = 0;

    public DiplomaEmpat(String nama, String nim, int tahun_masuk) {
        super(nama, nim, tahun_masuk);
    }

    public DiplomaEmpat(String nama, String fakultas, double ipk, int jumlah_sks, int tahun_masuk, int nomer_urut) {
        super(nama, fakultas, ipk, jumlah_sks, tahun_masuk, nomer_urut);
    }
    public int getSertifikatCount() {
        return sertifikatCount;
    }

    public int getProdukHki() {
        return produkHki;
    }
